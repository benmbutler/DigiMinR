...
```{r, fig.cap = "Interactive map of the soil samples associated with Cluster 1.", out.width='100%', message=FALSE, warning=FALSE, cache = TRUE}
library(leaflet)
library(plyr)
...
```{r, fig.cap = "Clustered pre-treated XRPD from Cluster 1.", out.width='100%', fig.align='center', fig.asp=0.75, cache = TRUE, message = FALSE, warning = FALSE}
